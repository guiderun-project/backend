...
public class UnknownExceptionAdvice {
    ...
    protected ResponseEntity<FailResult> handleUnknownException(UnknownException e) {
    ...
    protected ResponseEntity<FailResult> handleUnexpectedException(Exception e) {
